...
async function doIt() {
  const processId = fs.readFileSync(`./redstone-oracle-process/warp/processId_${env}.txt`, 'utf-8');
  const aoProcessId = fs.readFileSync(`./redstone-oracle-process/aos/aos_processId.txt`, 'utf-8');
