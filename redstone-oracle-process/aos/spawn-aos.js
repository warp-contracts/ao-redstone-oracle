...
const CODE = fs.readFileSync("./redstone-oracle-process/aos/process.lua", "utf-8");
...
async function doSpawn() {
  ...
  try {
    ...
    fs.writeFileSync('./redstone-oracle-process/aos/aos_processId.txt', processId, 'utf-8');
  } catch (e) {
    console.error(e);
  }
